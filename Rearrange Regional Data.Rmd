...
The idea of course is to end up with a table where each unique `unit` and `unit` and`unit` have one and only one `value`. This is absolutely necessary to clean up the data, and later to join the data with maps or other data. 
